...
func runServer(cmd *cobra.Command, args []string) {
	...
	http.HandleFunc("/api/admin/plugin/execute", withLogging(handlers.ApiRunPluginHandler))
	http.HandleFunc("/api/admin/plugin/result", withLogging(handlers.ApiGetPluginResultHandler))
	http.HandleFunc("/api/admin/plugin/history", withLogging(handlers.ApiGetPluginHistoryHandler))
